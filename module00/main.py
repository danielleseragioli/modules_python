...
def main():
    while True:
        ...
        if choice == "0":
            sys.path.append(os.path.join(base_dir, 'ex0'))
            test_ft_exercise("ft_hello_garden")
        elif choice == "1":
            sys.path.append(os.path.join(base_dir, 'ex1'))
            test_ft_exercise("ft_plot_area")
        elif choice == "2":
            sys.path.append(os.path.join(base_dir, 'ex2'))
            test_ft_exercise("ft_harvest_total")
        elif choice == "3":
            sys.path.append(os.path.join(base_dir, 'ex3'))
            test_ft_exercise("ft_plant_age")
        elif choice == "4":
            sys.path.append(os.path.join(base_dir, 'ex4'))
            test_ft_exercise("ft_water_reminder")
        elif choice == "5":
            sys.path.append(os.path.join(base_dir, 'ex5'))
            test_ft_exercise("ft_count_harvest_iterative")
            test_ft_exercise("ft_count_harvest_recursive")
        elif choice == "6":
            sys.path.append(os.path.join(base_dir, 'ex6'))
            test_ft_exercise("ft_garden_summary")
        elif choice == "7":
            sys.path.append(os.path.join(base_dir, 'ex7'))
        ...
        choice = input("Continue? Y(yes) or N(no): ")
